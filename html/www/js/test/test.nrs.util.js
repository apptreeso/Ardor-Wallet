...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(normalize(NRS.getAccountLink({entity: 5873880488492319831}, "entity")), "<a href='#' data-user='ARDOR-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'> <span class='regular-view'>/</span> <span class='mobile-view' style='display: none' title='/'>/</span> </a>", "numeric");
