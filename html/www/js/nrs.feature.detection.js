...
(isNode ? client : NRS).onSiteBuildDone().then(() => {
    NRS = (function (NRS) {
        ...
        NRS.isDeviceForcedRemoteNode = function (address, announcedAddress) {
            return (address === NRS.deviceSettings.remote_node_address || announcedAddress === NRS.deviceSettings.remote_node_address);
        };
