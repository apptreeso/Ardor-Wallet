...
NRS.onSiteBuildDone().then(() => {
    NRS = (function(NRS, $) {
        ...
        var addons = [
            ...
            {
                friendlyName      : "bundling",
                requestType       : "Bundling",
                getDataRequestType: "getBundlers",
                dataParameter     : "bundlers",
                accountParameter  : "bundler"
            },
            {
        ...
        NRS.forms.saveBundlingEncrypted = genericSaveEncrypted;
        ...
        NRS.forms.startBundlingEncrypted = genericStartEncrypted;
        ...
        NRS.forms.startBundlingEncryptedComplete = function (response) {
            if (Array.isArray(response.bundlers)) {
                $.growl($.t("started_bundlers", {count: response.bundlers.length}));
            }
        };
