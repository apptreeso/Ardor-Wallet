...
abstract contract IlluviumAware is ILinkedToILV {
     ...
     */
    constructor(IERC20 _ilv) {
        // verify ILV address is set and is correct
        require(address(_ilv) != address(0), "ILV address not set");
        require(
            _ilv.TOKEN_UID() == 0x83ecb176af7c4f35a45ff0018282e3a05a1018065da866182df12285866f5a2c,
